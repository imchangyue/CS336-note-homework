...
# 评测 'medium' 模型的 'forward_backward' 性能，上下文长度为 1024:
# python cs336_systems/benchmark.py --model_size medium --mode forward_backward --block_size 1024
#
# 评测 'large' 模型的 'forward' 性能，上下文长度为 2048:
# python cs336_systems/benchmark.py --model_size large --mode forward --block_size 2048
#
